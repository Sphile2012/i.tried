...
const BADGES = [
  ...
  { id: 'streak_7', name: 'Week Warrior', description: '7-day learning streak', icon: Flame, requirement: 7, category: 'streak' },
  ...
  { id: 'premium', name: 'Plus Member', description: 'Subscribe to Plus', icon: Crown, requirement: 1, category: 'special' },
  { id: 'pro', name: 'Career Developer', description: 'Subscribe to Career', icon: Rocket, requirement: 1, category: 'special' },
